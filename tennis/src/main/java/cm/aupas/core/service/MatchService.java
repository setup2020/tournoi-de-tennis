...
import cm.aupas.core.repository.MatchRepositoryImpl;
...
public class MatchService {
	...
	public void enregistrerNouveauMatch(Match match) throws SQLException {
	...
	public MatchDto getMatch(Long id) {
		...
		try {
			...
			match=this.matchRepository.getById(id);
			dto=new MatchDto();
	...
	public void deleteMath(Long id){
		Session session = null;
		Transaction tx=null;
